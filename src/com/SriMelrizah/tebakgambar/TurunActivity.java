...
public class TurunActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_turun);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "TURUN HUJAN";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), BatuActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.turun, menu);
		return true;
	}
