...
public class GulaActivity extends Activity {
	...
	public void cekJawaban(View v){
		String jawabanBenar = "KEMBANG GULA";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), MantuActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gula, menu);
		return true;
	}
