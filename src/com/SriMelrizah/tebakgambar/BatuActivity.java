...
public class BatuActivity extends Activity {
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BATU KARANG";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), GigiActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.batu, menu);
		return true;
	}
