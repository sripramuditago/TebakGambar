...
public class GigiActivity extends Activity {
	...
	public void cekJawaban(View v){
		String jawabanBenar = "GIGI KELINCI";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), KumisActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gigi, menu);
		return true;
	}
